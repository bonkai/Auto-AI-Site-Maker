...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        command_to_run = "use the terminal_execute tool to create a single page website with html, css, and javascript. The website should be a simple one page website with a header, a main content area, and a footer. The website should be styled with css and the content should be in the main content area."
